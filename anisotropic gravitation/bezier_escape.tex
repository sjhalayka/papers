...
It is tempting to believe that this $5$th interaction is the force behind the accelerating cosmic expansion.
If this is so, then is time contraction the high-level mechanism behind this $5$th interaction?
If this is so, then is the computational efficiency of the Universe increasing over time in general, because of the $2$nd law of thermodynamics, causing time contraction?
Again, it is tempting to believe so.
...
Finally, we discussed dark energy, and a $5$th interaction. 
