...
To compare against the past literature, where $v = \sqrt{GM/r} = 149108$, it is found that $D = 3$ exactly (e.g. where Newton's isotropic theory of gravitation still closely applies).
