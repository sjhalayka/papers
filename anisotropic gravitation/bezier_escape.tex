...
In general, where $ 2 < D < 3$, the value of the dimension will actually be a little bit greater than that given by Eq. 10, since the falloff is $(1/r) < x < (1/r^2)$.
...
The view that $M_{dark} > 0$ and the view that $D < 3$ are both correct at the same time -- they are complimentary ways of describing the same thing: anisotropic gravitation leads to dark matter, which leads to anisotropic gravitation, etc.
