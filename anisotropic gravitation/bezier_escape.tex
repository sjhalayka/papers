...
Do consider that the mass-energy density of the Sun (e.g. $1408$ kg per cubic metre) is quite large when compared to a dust (e.g. the Galaxy at $10^{-26}$ kg per cubic metre).
The smaller the mass-energy density, the more that dark matter factors in for gravitationally bound systems.
