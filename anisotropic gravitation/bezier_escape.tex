...
\end{tabular}
\end{center}
Note that isotropic gravitation is related to a 3-sphere in 4-dimensional space.
We take this to imply that the Universe is closed.
This model seems to retrodict the entire dark sector.
