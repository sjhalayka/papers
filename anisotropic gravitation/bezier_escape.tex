...
Do consider that the mass-energy density of the Sun (e.g. $1408$ kg per cubic metre) -- a highly pressurized body -- is quite large when compared to a practically pressure-free dust (e.g. the Galaxy at $10^{-26}$ kg per cubic metre).
The smaller the pressure density, the more that dark matter can factor in for gravitationally bound systems -- that is, dark matter production is eliminated in AU-scale processes by isotropic pressure.
