...
\end{tabular}
\end{center}
Note that isotropic gravitation is related to a 3-sphere in 4-dimensional space -- this implies that the Universe is finite, and closed.
This model retrodicts the entire dark sector.
