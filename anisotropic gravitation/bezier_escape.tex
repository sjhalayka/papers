...
Also note that we do not set $c = 1$, simply because to do would be to eliminate any scale-free behaviour, and cause a division by zero in Eq. 10 -- a sign that geometric units are inherently problematic when it comes to describing reality.
