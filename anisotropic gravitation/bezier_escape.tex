...
If dark matter is a condensate of {\textit{gravitating} gravitons, then it is like the ants and their pheromone trails: complex, emergent, self-reinforcing infrastructure occurs at the Galactic scale and larger, where gravitation is practically the only binding force.
The rich get richer, so to speak \cite{mm}.
...
\end{equation}
That is, the condensation of the gravitons forms a measurable amount of massive dark matter.
This view that there is massive dark matter, and the view that the gravitational interaction can have a spatial dimension less than 3 are both correct, depending on how you feel like interpreting the phenomena.
