...
{\textit{The smaller the pressure density, the more that dark matter can factor in}} for gravitationally bound processes -- that is, on the other hand, dark matter production is eliminated in AU-scale processes like our Solar System by isotropic pressure within the Sun.
