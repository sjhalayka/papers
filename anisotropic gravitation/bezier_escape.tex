...
\end{equation}
where $r = 6.96 \times 10^8$ is the closest distance (e.g. the Solar radius).
...
For example, the Einstein field equations, which are used to create the Schwarzschild solution discussed in the last section, are:
\begin{equation}
R_{\mu\nu} - \frac{1}{2} R g_{\mu\nu} + \Lambda g_{\mu\nu} = \kappa T_{\mu\nu},
\end{equation}
where $\kappa$ is
