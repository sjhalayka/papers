...
If dark matter is a condensate of {\textit{gravitating} gravitons, then it is like the ants and their pheromone trails -- that is, complex, emergent, self-reinforcing infrastructure also occurs at the Galactic scale and larger, where gravitation is practically the only binding force.
