...
Truthfully, the simulated Universe looks very much like ant trails, and biological neural networks -- the similarity is not coincidental.
The rich get richer, so to speak \cite{mm}, when it comes to forming a scale-free network in the cosmos.
