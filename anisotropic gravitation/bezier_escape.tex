...
\end{tabular}
\end{center}
Here, we have taken into account the 2-D nature of the strong interaction, and its 1-D communications (e.g. Wilson lines).
To extrapolate, isotropic gravitation is taken to be related to a 3-sphere in 4-D space, which implies that {\textit{the Universe is finite, and closed}}.
