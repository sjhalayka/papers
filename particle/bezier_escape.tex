...
The {\textit{only}} assumption is that the number of watts emitted is at least conserved, and if not then increased (e.g., $dP/dt \geq 0$), as the photon emitter goes from spherical, to circular, to beam-like.
