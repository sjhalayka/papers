...
The {\textit{only}} assumption is that the number of watts emitted is at least conserved, and if not then increased
\begin{equation}
\frac{dP}{dt} \geq 0, 
\end{equation}
as the photon emitter goes from spherical, to circular, to beam-like.
...
Is this the origin of the so-called dark matter in the large-scale, gravitationally-bound, aspherical systems (e.g. galaxies, filaments)?
