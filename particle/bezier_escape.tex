...
{\textit{The only assumption is that the Joules emitted per second is at least conserved, if not then increased, as the photon emitter goes from spherical, to circular, to beam-like.}}
