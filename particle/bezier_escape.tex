...
{\textit{The only assumption is that the temperature and the number of degrees of freedom are at least conserved, and if not then increased, as the photon emitter goes from spherical, to circular, to beam-like.}}
