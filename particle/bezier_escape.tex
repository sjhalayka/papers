...
\title{On the anisotropic emission of photons}
...
\begin{abstract}
The anisotropic emission of photons is considered.
...
{{The {\textit{only}} assumption is that the temperature $T$ and the number of degrees of freedom $f$ are at least conserved, and if not then increased, as the photon emitter goes from spherical, to circular, to beam-like over time $t$:}}
\begin{equation}
\frac{dT}{dt} \geq 0, \; \frac{df}{dt} \geq 0.
\end{equation}
...
The C++ code for the numerical method can be found at:\\
\url{https://github.com/sjhalayka/particle}
