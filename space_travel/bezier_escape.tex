...
\end{equation}
The entropy is independent of the black hole's speed -- it's all external process, all the time.
Otherwise, for non-black holes, it's assumed that the entropy of an accelerated test body can never reach $S_{BH}$, because the speed of light is not attainable.
