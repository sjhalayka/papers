...
Otherwise, for non-black holes, it's assumed that the entropy of an accelerated test body can never reach $S_{BH}$, because the speed of light is not attainable, and so the process can never be perfectly hyperfocused in one particular direction.
