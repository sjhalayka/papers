...
\end{equation}
The entropy is independent of the black hole's speed because the black hole is all about external process, all the time, and so the entropy is independent of how focused this perfect external process is in one particular direction.
