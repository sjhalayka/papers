...
z = \frac{(n - 1)n}{2}.
\end{equation}
The focus $\omega$ (i.e. anisotropy, speed) is the normalized average dot product:
\begin{equation}
...
\end{equation}
%The speed can also be obtained from the relativistic Doppler effect \cite{ae}, which head-on is:
%\begin{equation}
%f^\prime = \frac{f}{\sqrt{1 - v^2}}.
%\end{equation}
%Here, $f^\prime$ is the frequency emitted in motion, and $f$ is the frequency emitted at rest.
