...
Consider a dust toy model, where $n$ is the number of fully uncoupled asymmetric oscillators comprising the non-black hole, and the total dot product $y$ is:
\begin{equation}
