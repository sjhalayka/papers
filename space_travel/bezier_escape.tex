...
\end{equation}
The asymmetric oscillator is deemed to be moving, considering that the asymmetry would be due to the head-on relativistic Doppler effect \cite{ae}:
\begin{equation}
v = \frac{f^2 - {f^\prime}^2}{f^2 + {f^\prime}^2}.
\end{equation}
where $f$ represents rest frequency, and $f^\prime$ represents moving frequency.
