...
The theory put forward in this paper is experimentally verifiable, and even if $\lambda = \lfloor{1}/{dt} \rfloor$ is found to not be a part of reality, the {\textit{principle}} that {{entropy is the measure of external connectivity}} still holds true.
