...
\end{equation}
The asymmetric oscillator is deemed to be moving with speed $\omega$, considering that the asymmetry would be due to the head-on relativistic Doppler effect \cite{ae}.
