...
\end{equation}
The speed can also be obtained from the math that describes the relativistic Doppler effect \cite{ae}, which head-on is:
\begin{equation}
f^\prime = \frac{f}{\sqrt{1 - v^2}} \rightarrow v = \frac{\sqrt{{f^\prime}^2 - f^2}}{f^\prime}
\end{equation}
Here, $f^\prime$ is the frequency of light emitted in motion, and $f$ is the frequency of light emitted at rest.
