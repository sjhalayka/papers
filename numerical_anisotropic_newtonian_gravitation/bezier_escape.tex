...
\title{On anisotropic Newtonian gravitation}
...
For instance, for the Galactic orbit of the Solar System at $R = 3 \times 10^{20}$ metres, where the mass is $M = 1 \times 10^{41}$ kilograms, and the circular orbit speed is $v = 220000$ metres per second, the ratio is only $2.17551$.
