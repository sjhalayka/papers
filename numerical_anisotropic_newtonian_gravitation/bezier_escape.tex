...
g = -\alpha. 
\end{equation}
The receiver is taken to be a unit circle.
...
\begin{equation}
v_{\textrm{target}} = {\textrm {flat rotation curve constant}}, %x v_N,
\end{equation}
\begin{equation}
...
That is, the closer the normal is to the position's tangent plane, the more the non-Newtonian the falloff is.
