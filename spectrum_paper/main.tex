...
Here, $\theta_{bh}, \phi_{bh}, r_{bh}$ describe the observer's position with respect to the black hole:
\begin{equation}
...
J =
%\begin{pmatrix}
%\dfrac{\partial s}{\partial x} & \dfrac{\partial s}{\partial y} & \dfrac{\partial s}{\partial z} \\
%\dfrac{\partial t}{\partial x} & \dfrac{\partial t}{\partial y} & \dfrac{\partial t}{\partial z} \\
%\dfrac{\partial u}{\partial x} & \dfrac{\partial u}{\partial y} & \dfrac{\partial u}{\partial z}
%\end{pmatrix} =
\begin{pmatrix}
\sin\theta_{bh}\cos\phi_{bh} & \sin\theta_{bh}\sin\phi_{bh} & \cos\theta_{bh} \\[4pt]
\dfrac{\cos\theta_{bh}\cos\phi_{bh}}{r_{bh}} & \dfrac{\cos\theta_{bh}\sin\phi_{bh}}{r_{bh}} & -\dfrac{\sin\theta_{bh}}{r_{bh}} \\[8pt]
