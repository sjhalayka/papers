...
h = 2\pi .
\end{equation}
This single fact is responsible for the factors of $2\pi$ that appear in the black-body formulae below. The metric signature is taken to be $(-,+,+,+)$. We restore SI factors only when reporting numbers that are to be compared with observation.
...
Exogeneity is also a measure of how much of the process is made up of surface points (versus made up of internal points).
For instance, a black hole is all surface, where the exogeneity is maximal.
