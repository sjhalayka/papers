...
$(\dot v^r,\dot v^\theta,\dot v^\phi)$. These are related by the chain rule through the
Jacobian of the coordinate map.

\subsection{Spherical $\to$ Cartesian}
...
\subsection{Inverting: Cartesian $\to$ spherical}
