...
Entropy can be taken to describe the level of intraconnectivity of a mass.
...
Thus, for highly kinematically time dilated materials, entropy should be next to zero
\begin{equation}
S \approx 0.
\end{equation}
