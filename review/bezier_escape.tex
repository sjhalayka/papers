...
The $x$ axis is distance $r$, and the $y$ axis is the intersection count gradient times $GM c^0 r^3$, where $D = 3.0$. $n = 10,000,000$.
}
\end{figure}
...
\centering
  ...
  \caption{
Demonstration of banding.
The $x$ axis is distance $r$, and the $y$ axis is the intersection count gradient times $GM c^0 r^3$, where $D = 3.0$. $n = 100,000,000$.
