...
See Figs. 1 and 2 for a simplified analytical solution for anisotropic gravitation, which does not take the change in gravitational falloff into account.
...
For instance, Fig. 3 shows the intersection count (e.g. field strength) as the dimension of the gravitational field goes from $D = 2.001$ to $D = 3.0$. 
...
In other words, the code does not take this small change in falloff into account.
}
\end{figure}
