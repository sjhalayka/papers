...
\begin{enumerate}
\item Why is gravitation so weak? Because it's often isotropic.
\item Why is gravitation stronger than that predicted by general relativity in dusts such as the Galactic disc? Fractional dimension due to anisotropic gravitation.
