...
\centering
  ...
  \caption{
Here $D = 2.001$.
Here the $x$ axis is distance $r$, and the $y$ axis is intersection count times falloff $f = r^1$.
...
\centering
  ...
  \caption{
Here $D = 2.5$.
Here the $x$ axis is distance $r$, and the $y$ axis is intersection count times falloff $f = r^{1.5}$.
...
\centering
  ...
  \caption{
Here $D = 3$.
Here the $x$ axis is distance $r$, and the $y$ axis is intersection count times falloff $f = r^2$.
Note that the output appears to be fractal in nature -- non-differentiable anyway.
