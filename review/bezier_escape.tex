...
In this paper we will address the following three big questions:
\begin{enumerate}
...
\item The dark energy problem: why is the Universe's expansion accelerating?
\end{enumerate}
...
\item Why is the Universe's expansion accelerating? Accelerating computational self-optimization.
\end{enumerate}
