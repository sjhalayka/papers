...
We have constructed Table 1 by first taking into account the inherent 2-D (e.g. triangular) nature of the strong interaction, and its 1-D communications (e.g. some Wilson lines).
