...
\title{On unwanted repulsive acceleration in the Schwarzschild gravitational theories consisting of quantized field lines, for C++ programmers}
...
For instance, where $r_{r} = r_{e} \times 0.01$, it is found that gravitation can be repulsive at close range.
...
We will likely have to resort to the cosine weighted random vectors for generating the gravitons -- to get rid of field lines, and repulsive gravity, altogether.
This is the work of a future paper.

The full codes for this paper can be found at:
