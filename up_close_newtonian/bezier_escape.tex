...
Perhaps converting the model from using field lines to using gravitons will solve this problem.
...
We will likely have to use the cosine-weighted random vectors for generating the gravitons.
