	...
	const double receiver_radius)
{
	...
	for (long long unsigned int i = 0; i < n; i++)
	{
		...
		//glm::dvec3 normal = 
		//	random_cosine_weighted_hemisphere(surface_normal);

		// C) Schwarzschild gravitation using a useful trick
		//glm::dvec3 normal = 
		//	glm::normalize(
		//		surface_normal + random_unit_vector());

		// D) Emulate Quantum Graphity to get 
		// Schwarszschild gravitation
		glm::dvec3 normal = 
			glm::normalize(
				location - 
...
vector_3 random_cosine_weighted_hemisphere(const vector_3& normal)
{
	...
	glm::dvec3 uu = 
		glm::normalize(
			glm::cross(normal, glm::dvec3(0.0, 1.0, 1.0)));
...
For instance, see Fig. 3 for an image produced using path tracing.
