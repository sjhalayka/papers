...
See Fig. 3 for a plot showing the strength of gravitation with regard to Schwarszschildian versus Newtonian regimes.
...
\label{fig3}
  ...
  \caption{
Plot showing the strength of gravitation with regard to Schwarszschildian versus Newtonian regimes.
}
\end{figure}
