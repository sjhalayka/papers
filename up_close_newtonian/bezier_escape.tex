...
See Fig. 4 for a plot of the onset of repulsive gravitation mean distance $d$ based on field line count $n$, where $d \propto \sqrt{n}$.
...
The plot forms an approximately straight line.
