...
For instance, the onset distance for an Earth-mass Schwarzschild black hole is $1.03 \pm 2.12\mathrm{e}{-7}$ astronomical units (AU).

We leave the Kerr metric (e.g., curved field lines where there is the possibility of multiple intersections per line) for a future tutorial.
