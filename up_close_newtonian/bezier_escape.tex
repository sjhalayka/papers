...
See Fig. 4 for a plot of the onset of repulsive gravitation mean distance based on field line count $n$.
...
\label{fig4}
  ...
  \caption{
A plot showing the onset of repulsive gravitation mean distance based on field line count.
The plot forms an approximately straight line.
The standard deviations also form an approximately straight line.
}
\end{figure}
