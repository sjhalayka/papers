...
It is found that with non-normal messenger particle emission comes increased gravitational strength -- matching that from the Schwarzschild solution.
...
It should be noted that repulsive gravitation plagues all non-normal (e.g. cosine weighted random normal) theories.
