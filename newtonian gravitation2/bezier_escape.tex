...
We consider that the pressure density is near zero at the Galactic scale (e.g. pressure per kiloparsec), which simplifies the equations, and allows for anistropic gravitation.
