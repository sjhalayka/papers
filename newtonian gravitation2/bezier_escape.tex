...
%In effect, a black hole represents a gigantic integer.%
...
For the sake of reference, attached below is a visualization that highlights the difference between Newtonian (e.g. Keplerian) orbit and flat rotation curve orbit, in terms of the relativistic Doppler effect:
\begin{figure} 
\centering
\label{fig2}
  \includegraphics[width = 7 in]{doppler.png}
  \caption{
Visualization of the relativistic Doppler effect for $10^5$ stars.
