...
\end{equation}
Thus, $n$ is the gravitational field line count.
...
\end{equation}
It should be noted that the inherent strength of the interaction does not run with the reduction of dimension in Rubinian gravity.
