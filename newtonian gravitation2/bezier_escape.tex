...
For example, in terms of the set of 8-bit integers, where there are $W$ distinct microstates, the Shannon binary entropy $n$ is:
\begin{equation}
n = \frac{\log W}{\log 2}.
\end{equation}
The number of distinct 8-bit integers is 256, and so the binary entropy is $n = 8$ and $W= 256$.
This is to say that if you understand the 8-bit integers, then you understand entropy.
