...
In Fig. 6 we show field line normals that radiate outward like in standard Newtonian gravity.
In Fig. 7 we show field normals that are pseudorandomly-generated.
Where $x \approx 1$, the field lines generated by both methods become indistinguishable.
\begin{figure} 
\centering
  \includegraphics[width = 6 in]{normals.png}
  \caption{
$n = 10000$ field line starting positions on a unit 2-sphere, where each of the $n$ normals (e.g. field line directions) are equal to their respective positions.
}
\end{figure}
\begin{figure} 
\centering
  \includegraphics[width = 6 in]{rand_normals.png}
  \caption{
$n = 10000$ field line starting positions on a unit 2-sphere, where each of the $n$ normals (e.g. field line directions) are pseudorandom (but pointing outward).
}
\end{figure}
