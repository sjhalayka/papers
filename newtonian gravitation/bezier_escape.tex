...
As for predictability, for instance where $n = 10^7$ (e.g. $r_{\textit{emitter}} = 6.46109 \times 10^{-21}$ metres) it is found that at a distance of $170.521$ metres that the gradient strength $0.999615$ dips below $1.0$.
This distance value depends entirely on our choice of the holographic principle.
