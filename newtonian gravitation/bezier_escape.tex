...
%  \frac{r_{\textit{e}}}{2 R^2 \sqrt{1 - {r_{\textit{e}}}/{R}}}.
% - \frac{1}{R \sqrt{1 - {r_{\textit{e}}}/{R}}}.
\end{equation}
Here we derive Newton's partial derivative so that it is numerically and dimensionally correct:
\begin{equation}
