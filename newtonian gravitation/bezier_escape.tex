...
\section{Typedefs}
In our code, we leave the type up to the coder.
...
Rather than allocating gigabytes of RAM, we can use a heuristic approach to solve the same problem that was solved in the previous section.
