...
We cover the following six subjects:
\begin{enumerate}
...
%\item General relativity versus Newtonian gravitation \cite{misner}.
\end{enumerate}
...
\centering
\label{fig3}
  \includegraphics[width = 5 in]{velocity.png}
  \caption{
...
\centering
\label{fig4}
  \includegraphics[width = 5 in]{position.png}
  \caption{
