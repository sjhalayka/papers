...
Here $r$ is the receiver radius, $R$ is the distance from the centre of the emitter, and $\beta$ is the collision count function:		
\begin{equation}
...
\end{equation}
\begin{equation}
g_N = \frac{n c \hbar \log 2}{4 \pi M R^2} = \frac{c^4 A}{16 \pi G M R^2} = \frac{G M}{R^2}.
\end{equation}
