...
Like with the irradience of light and the intensity of sound, we assume in this paper that the acceleration in Newton's gravity follows an inverse-square law:
\begin{equation}
g_N \propto \frac{1}{R^2}.
\end{equation}
See Fig. 1.

The other assumption that we make in this paper is that the Newtonian gravitational field line count is given by the holographic principle, for lack of a better guess.
...
\begin{figure} 
\centering
  \includegraphics[width = 4 in]{inverse_square_law.png}
  \caption{
