...
Like with the irradience of light and the intensity of sound, we assume that the acceleration in Newton's gravity follows an inverse-square law:
\begin{equation}
g \propto \frac{1}{R^2}.
\end{equation}
See Fig. 1.
...
The intensity of the gravitation (e.g. brightness) is proportional to $1/R^2$.
}
\end{figure}
