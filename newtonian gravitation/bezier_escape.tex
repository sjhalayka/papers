...
Here we show normals that radiate outward like in standard Newtonian gravity:
\begin{figure} 
\centering
  \includegraphics[width = 3 in]{normals.png}
  \caption{
...
\begin{figure} 
\centering
  \includegraphics[width = 3 in]{rand_normals.png}
  \caption{
